...
class CSVFile:
    ...
    def get_data(self):
        ...
        if not self.can_read:
            ...
            #raise EXex('Errore in apertura del file')
...
#  Esempio di utilizzo
#==============================
#MyExamException = ExamException()
time_series_file = CSVFile(name='data.csv')
#if mio_file.can_read == False:
#   raise MyExamException("!")
#raise ExamException('Errore in conversione del valore "{}" a numerico: "{}"'.format(element, e))
...
mio_file_numerico = NumericalCSVFile(name='data.csv')
